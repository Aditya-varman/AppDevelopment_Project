...
//     navigate('/claims'); // Navigate to the ClaimTabs route
//   };
...
//             </p>
//             <button
//               onClick={handleFileClaimClick} // Handle button click
//               className="flex mx-auto mt-7 text-white bg-[#EE744D] border-0 py-2 px-8 focus:outline-none hover:bg-[#FF4500] rounded text-lg"
//             >
//               File a Claim &gt;
//             </button>
...
//                 </h2>
//                 <p className="leading-relaxed text-base">
//                   Call us at +91 93283-73131 / +91 85114-411930 to clear your queries.
//                 </p>
//               </div>
//             </div>
//             <div className="p-4 md:w-1/3 flex flex-col text-center items-center bg-white border rounded shadow-xl">
